...
"[project]/src/app/api/commissions/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const commissions = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$models$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Commission"].find(query).sort({
            createdAt: -1
        });
        // Populate with lead and course info
        const leadIds = [
            ...new Set(commissions.map((c)=>c.leadId))
        ];
        const leads = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$models$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Lead"].find({
            _id: {
                $in: leadIds
            }
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__18a34d9c._.js.map